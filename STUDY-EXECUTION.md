...
- _**database.csv**_: Contains metadata information that you supplied as part of running the package to identify the database across the OHDSI network. Additionally, the vocabulary version used in your CDM is included and the min/max observation_period start/end dates to understand the period covered by the CDM.
