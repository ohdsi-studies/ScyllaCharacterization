...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1119119,1114375,1510627,1397141,912263,19095164,997276,1518254,19080458,1151789,953076,1361614,40226579,19041065,44507848,937368,1506270,950696,44785507,1550557,1551099,961047,19011685,40244464,1594587,44818461,950637,40171288,42904205,1361580,40161532)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1119119,1114375,1510627,1397141,912263,19095164,997276,1518254,19080458,1151789,953076,1361614,40226579,19041065,44507848,937368,1506270,950696,44785507,1550557,1551099,961047,19011685,40244464,1594587,44818461,950637,40171288,42904205,1361580,40161532)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45700935,41107154,36882756,4173939,21603877,40213271,2213426,2213425)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (45700935,41107154,36882756,4173939,21603877,40213271,2213426,2213425)
  and c.invalid_reason is null
...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (36217207,36244021,36217208,36217213,36217218,36217217,36217211,36244034,36244026,36217206,36217209)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (36217207,36244021,36217208,36217213,36217218,36217217,36217211,36244034,36244026,36217206,36217209)
  and c.invalid_reason is null
...
WHERE C.drug_exposure_start_date >= DATEFROMPARTS(2020, 01, 01)
