...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1369939,40239056,930021,1344381,1101554,1363053,1350489,19012925,924566,1341238,1303425)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1369939,40239056,930021,1344381,1101554,1363053,1350489,19012925,924566,1341238,1303425)
...
WHERE C.observation_date >= DATEFROMPARTS(2020, 01, 01)
