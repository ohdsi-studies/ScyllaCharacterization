...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1367500,1308842,40226742,1347384,1317640,1351557,40235485,1346686)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1367500,1308842,40226742,1347384,1317640,1351557,40235485,1346686)
