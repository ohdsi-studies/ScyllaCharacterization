...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1789428,1727223,1711523,1715472,1748921,1746244,1756831,1736829,1738170,1736999)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1789428,1727223,1711523,1715472,1748921,1746244,1756831,1736829,1738170,1736999)
