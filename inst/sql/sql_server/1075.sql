...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45700935,41107154,4173939,21603877,2213425,2213426,40213271,36882756)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (45700935,41107154,4173939,21603877,2213425,2213426,40213271,36882756)
