...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1308216,1335471,1341927,1334456,1331235,1363749,1373225,1340128,1342439,1310756,19122327,1342001,19050216,19102107,19040051)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1308216,1335471,1341927,1334456,1331235,1363749,1373225,1340128,1342439,1310756,19122327,1342001,19050216,19102107,19040051)
