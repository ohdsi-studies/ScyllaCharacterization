...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1713332,1734104,1777806,1797513,1789276,1716721,1742253,1716903,1721543,923081)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1713332,1734104,1777806,1797513,1789276,1716721,1742253,1716903,1721543,923081)
