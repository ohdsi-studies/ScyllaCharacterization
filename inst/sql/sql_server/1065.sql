...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1580747,40166035,40239216,43013884,19122137,43009089,43009051)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1580747,40166035,40239216,43013884,19122137,43009089,43009051)
