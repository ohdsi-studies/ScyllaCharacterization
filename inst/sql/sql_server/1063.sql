...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1545958,1539403,1551860,1510813,1592085,40165636,1549686,1592180)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1545958,1539403,1551860,1510813,1592085,40165636,1549686,1592180)
