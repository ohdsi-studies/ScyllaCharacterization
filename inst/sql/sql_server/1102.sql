...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19024063,1347450,43013024,1112807,19069137,1322184,45775372,40228152,45892847,1301025,1367571,40163718,40241331,1310149)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (19024063,1347450,43013024,1112807,19069137,1322184,45775372,40228152,45892847,1301025,1367571,40163718,40241331,1310149)
