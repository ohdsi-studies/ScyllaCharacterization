...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40059335,36222583,36222584,36222585,19048077,1748986,19048071,1748988,19048075)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40059335,36222583,36222584,36222585,19048077,1748986,19048071,1748988,19048075)
