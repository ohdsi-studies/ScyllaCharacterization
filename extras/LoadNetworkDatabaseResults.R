...
cohortXref <- read.csv(system.file("shiny/ResultsExplorer/cohortXref.csv", package = "ScyllaCharacterization"), header = TRUE)
...
# Load in the results
library(readr)
zipDirRoot <- "E:/ScyllaCharacterization/Results"
